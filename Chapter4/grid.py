...
from PyQt6.QtWidgets import (
    QApplication, QWidget, QLabel, QLineEdit, QCheckBox, QTextEdit, QGridLayout)
...
class MainWindow(QWidget):
    ...
    def saveWidgetValues(self):
        ...
        for row in range(2, 9):
            ...
            with open("Chapter4/details.txt", "w") as f:
    ...
    def loadWidgetValuesFromFile(self):
        ...
        try:
            with open("Chapter4/details.txt", "r") as f:
                details = json.load(f)
