...
class LoginWindow(QWidget):
    ...
    def clickLoginButton(self):
        """Check if username and password match any existing entries in users.txt. If found, show QMessageBox and close the program. If they don't, display a warning QMessageBox."""
