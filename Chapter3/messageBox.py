...
class MainWindow(QWidget):
    ...
    def searchAuthors(self):
        """Search through a catalogue of names. If a name is found, display the Author Found dialog.
        ...
        try:
            ...
            if self.author_edit.text() in authors:
                QMessageBox.information(
                    self, "Author Found", "Author found in catalogue!", QMessageBox.StandardButton.Ok)
            else:
                answer = QMessageBox.question(self, "Author Not Found", """<p>Author not found in catalogue.</p>
